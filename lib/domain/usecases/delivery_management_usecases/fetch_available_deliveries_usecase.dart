...
class FetchAvailableDeliveriesUseCase
    extends UseCase<List<DeliveryEntity>, NoParam> {
  FetchingDeliveriesRepo fetchingDeliveriesRepo;
  FetchAvailableDeliveriesUseCase(this.fetchingDeliveriesRepo);

  @override
  Future<Either<Failure, List<DeliveryEntity>>> call([NoParam? param]) async {
    // check permission
    return await fetchingDeliveriesRepo.fetchAvailableDeliveries();
  }
}
