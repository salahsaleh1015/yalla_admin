...
class FetchUnAvailableDeliveriesUseCase
    extends UseCase<List<DeliveryEntity>, NoParam> {
  FetchingDeliveriesRepo fetchingDeliveriesRepo;
  FetchUnAvailableDeliveriesUseCase(this.fetchingDeliveriesRepo);

  @override
  Future<Either<Failure, List<DeliveryEntity>>> call([NoParam? param]) async {
    // check permission
    return await fetchingDeliveriesRepo.fetchUnAvailableOrders();
  }
}
