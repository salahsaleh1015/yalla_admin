...
class GetTheNumberOfUsersUseCase extends UseCase<int, NoParam> {
  HomeStatisticsCardsRepo homeStatisticsCardsRepo;

  GetTheNumberOfUsersUseCase(this.homeStatisticsCardsRepo);

  @override
  Future<Either<Failure, int>> call([NoParam? param]) async {
    return await homeStatisticsCardsRepo.getTheNumberOfUsers();
  }
}